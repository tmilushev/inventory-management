...
<script>
// ABOUTME: Reports view displaying quarterly performance tables, monthly revenue bar chart,
// ABOUTME: month-over-month comparison table, and summary stats with filter support.
